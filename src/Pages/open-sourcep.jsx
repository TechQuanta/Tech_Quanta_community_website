...
const App = () => {
    ...
    // 1. Initial Data Load Effect (Runs ONCE)
    useEffect(() => {
    ...
    // 2. Project Change Effect (Simulates the PER-PROJECT FETCH/REFRESH)
    useEffect(() => {
    ...
    if (loadingInitial) {
             return (
                 <div className="min-h-screen flex items-center justify-center bg-trasnparent">
