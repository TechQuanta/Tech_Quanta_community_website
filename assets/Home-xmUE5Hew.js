import{u as Y,r as d,M as F,m as G,a as Q,f as V,c as X,i as H,j as e,b as S,d as D,R as A,F as K,e as Z,g as J,h as U,k as ee,H as te}from"./index-DypoEZZ9.js";/* empty css             */function z(n){const t=Y(()=>G(n)),{isStatic:i}=d.useContext(F);if(i){const[,r]=d.useState(n);d.useEffect(()=>t.on("change",r),[])}return t}function ne(n,t){const i=z(t()),r=()=>i.set(t());return r(),Q(()=>{const c=()=>V.preRender(r,!1,!0),s=n.map(l=>l.on("change",c));return()=>{s.forEach(l=>l()),X(r)}}),i}function M(n,...t){const i=n.length;function r(){let c="";for(let s=0;s<i;s++){c+=n[s];const l=t[s];l&&(c+=H(l)?l.get():l)}return c}return ne(t.filter(H),r)}/**
